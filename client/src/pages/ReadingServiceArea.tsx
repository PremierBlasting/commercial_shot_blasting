      ...
      <HeroCarousel className="py-16 md:py-24">
        <div className="max-w-3xl">
          ...
          <p className="text-lg text-white/90 mb-8">
            Commercial Shot Blasting provides professional surface preparation and rust removal services throughout Reading and Berkshire. Serving local manufacturers, industrial facilities, and commercial projects with precision blasting solutions.
          </p>
