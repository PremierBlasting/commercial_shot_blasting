...
export default function WalesBordersCounty() {
  const [quotePopupOpen, setQuotePopupOpen] = useState(false);

  useEffect(() => {
    document.title = "Shot Blasting Wales & Borders | Service Areas";
    
    // Set keywords meta tag
    const metaKeywords = document.querySelector('meta[name="keywords"]');
    if (metaKeywords) {
      metaKeywords.setAttribute('content', 'shot blasting Wales & Borders, mobile shot blasting, rust removal, surface preparation, Wales & Borders');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'keywords';
      meta.content = 'shot blasting Wales & Borders, mobile shot blasting, rust removal, surface preparation, Wales & Borders';
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Professional shot blasting services across Wales and the border counties. Covering Cardiff, Hereford, Wrexham, Newport and surrounding areas.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Professional shot blasting services across Wales and the border counties. Covering Cardiff, Hereford, Wrexham, Newport and surrounding areas.';
      document.head.appendChild(meta);
    }
    ...
    if (ogTitle) {
      ogTitle.setAttribute('content', 'Shot Blasting Wales & Borders | Service Areas');
    }

    const ogDescription = document.querySelector('meta[property="og:description"]');
    if (ogDescription) {
      ogDescription.setAttribute('content', 'Professional shot blasting services across Wales and the border counties. Covering Cardiff, Hereford, Wrexham, Newport and surrounding areas.');
    }
        ...
        <div className="container relative">
          <Breadcrumb 
            items={[
              ...
              { label: "Wales & Borders", href: "/service-areas/wales-borders" }
            ]}
          />
          <div className="max-w-3xl mt-8">
            <div className="flex items-center gap-2 text-[#7ac5e3] mb-4">
              <MapPin className="h-5 w-5" />
              <span className="text-sm font-medium uppercase tracking-wider">Wales & Borders Region</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6 font-display">
              Shot Blasting Services in Wales & Borders
            </h1>
            <p className="text-xl text-gray-200 mb-8">
              Professional shot blasting services across Wales and the border counties. Covering Cardiff, Hereford, Wrexham, Newport and surrounding areas.
            </p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1e3a5f] mb-4">
              Our Service Areas in Wales & Borders
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              We provide professional shot blasting services across all areas of Wales & Borders. 
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-[#1e3a5f] mb-6">
                Professional Shot Blasting Across Wales & Borders
              </h2>
              <p className="text-gray-600 mb-6">
                Our mobile shot blasting teams cover the entire Wales & Borders region, providing 
            ...
            <div className="relative">
              <img loading="lazy"
                ...
                alt="Shot blasting services in Wales & Borders"
      ...
      <section className="py-16 bg-[#1e3a5f] text-white">
        <div className="container text-center">
          <h2 className="text-3xl font-bold mb-4">
            Ready to Get Started in Wales & Borders?
          </h2>
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Contact us today for a free quote on your shot blasting project. 
            We cover all areas of Wales & Borders with our mobile shot blasting service.
          </p>
