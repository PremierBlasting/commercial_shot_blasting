...
export default function LincolnshireCounty() {
  ...
  useEffect(() => {
    document.title = "Shot Blasting Lincolnshire | Service Areas";
    
    const metaKeywords = document.querySelector('meta[name="keywords"]');
    if (metaKeywords) {
      metaKeywords.setAttribute('content', 'shot blasting Lincolnshire, mobile shot blasting, rust removal, surface preparation, Lincolnshire');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'keywords';
      meta.content = 'shot blasting Lincolnshire, mobile shot blasting, rust removal, surface preparation, Lincolnshire';
      document.head.appendChild(meta);
    }

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Shot Blasting Lincolnshire - Professional rust removal & surface preparation. Covering Lincoln, Grantham, Scunthorpe. Call 07970 566409');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Shot Blasting Lincolnshire - Professional rust removal & surface preparation. Covering Lincoln, Grantham, Scunthorpe. Call 07970 566409';
      document.head.appendChild(meta);
    }

    const ogTitle = document.querySelector('meta[property="og:title"]');
    if (ogTitle) {
      ogTitle.setAttribute('content', 'Shot Blasting Lincolnshire | Service Areas');
    }

    const ogDescription = document.querySelector('meta[property="og:description"]');
    if (ogDescription) {
      ogDescription.setAttribute('content', 'Shot Blasting Lincolnshire - Professional rust removal & surface preparation. Covering Lincoln, Grantham, Scunthorpe. Call 07970 566409');
    }
        ...
        <div className="container relative">
          <Breadcrumb 
            items={[
              ...
              { label: "Lincolnshire", href: "/service-areas/lincolnshire" }
            ]}
          />
          <div className="max-w-3xl mt-8">
            <div className="flex items-center gap-2 text-[#7ac5e3] mb-4">
              <MapPin className="h-5 w-5" />
              <span className="text-sm font-medium uppercase tracking-wider">Lincolnshire</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6 font-display">
              Shot Blasting Services in Lincolnshire
            </h1>
            <p className="text-xl text-gray-200 mb-8">
              Professional shot blasting services across Lincolnshire. Covering Lincoln, Grantham, Scunthorpe and surrounding areas.
            </p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1e3a5f] mb-4">
              Our Service Areas in Lincolnshire
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              We provide professional shot blasting services across all areas of Lincolnshire. 
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-[#1e3a5f] mb-6">
                Professional Shot Blasting Across Lincolnshire
              </h2>
              <p className="text-gray-600 mb-6">
                Our mobile shot blasting teams cover the entire Lincolnshire region, providing 
            ...
            <div className="relative">
              <img loading="lazy"
                ...
                alt="Shot blasting services in Lincolnshire"
      ...
      <section className="py-16 bg-[#1e3a5f] text-white">
        <div className="container text-center">
          <h2 className="text-3xl font-bold mb-4">
            Ready to Get Started in Lincolnshire?
          </h2>
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Contact us today for a free quote on your shot blasting project. 
            We cover all areas of Lincolnshire with our mobile shot blasting service.
          </p>
