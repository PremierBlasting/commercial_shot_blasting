...
export default function IpswichServiceArea() {
  ...
  useEffect(() => {
    document.title = "Shot Blasting Ipswich | Commercial & Industrial";
    
    // Set keywords meta tag
    const metaKeywords = document.querySelector('meta[name="keywords"]');
    if (metaKeywords) {
      metaKeywords.setAttribute('content', 'shot blasting Ipswich, rust removal, surface preparation, industrial blasting, Suffolk');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'keywords';
      meta.content = 'shot blasting Ipswich, rust removal, surface preparation, industrial blasting, Suffolk';
      document.head.appendChild(meta);
    }
  }, []);

  useEffect(() => {
    const description = locationData["ipswich"].description;
    ...
    if (ogTitle) {
      ogTitle.setAttribute('content', 'Shot Blasting Ipswich');
    } else {
      const meta = document.createElement('meta');
      meta.setAttribute('property', 'og:title');
      meta.setAttribute('content', 'Shot Blasting Ipswich');
      document.head.appendChild(meta);
    }
    ...
    if (twitterTitle) {
      twitterTitle.setAttribute('content', 'Shot Blasting Ipswich');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'twitter:title';
      meta.content = 'Shot Blasting Ipswich';
      document.head.appendChild(meta);
    }
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ fontFamily: "'Open Sans', sans-serif" }}>
      ...
      </HeroCarousel>{/* Why Choose Us Section (Tailored for Ipswich) */}
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img loading="lazy" src="https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=600" alt={`Shot blasting in ${locationName}`} className="rounded-lg shadow-xl" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Professional Preparation & Cleanup Excellence
              </h2>
              <p className="text-lg text-gray-600 mb-8">
                Shot blasting quality is determined by preparation and cleanup standards. We implement a proven four-stage process for site containment, protective measures, and thorough restoration – delivering predictable results and leaving Ipswich sites ready for immediate next steps.
              </p>
...
<footer className="bg-[#2C2C2C] text-white py-8">
      ...
      <NearbyTowns 
        locationName={nearbyTownsData["ipswich"].location}
        towns={nearbyTownsData["ipswich"].towns}
      />
