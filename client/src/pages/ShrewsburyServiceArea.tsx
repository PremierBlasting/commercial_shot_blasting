...
export default function ShrewsburyServiceArea() {
  ...
  useEffect(() => {
    document.title = "Shot Blasting Shrewsbury | Industrial Services";
    
    // Set keywords meta tag
    const metaKeywords = document.querySelector('meta[name="keywords"]');
    if (metaKeywords) {
      metaKeywords.setAttribute('content', 'shot blasting Shrewsbury, rust removal, surface preparation, industrial blasting, Shropshire');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'keywords';
      meta.content = 'shot blasting Shrewsbury, rust removal, surface preparation, industrial blasting, Shropshire';
      document.head.appendChild(meta);
    }
  }, []);

  useEffect(() => {
    const description = locationData["shrewsbury"].description;
    ...
    if (ogTitle) {
      ogTitle.setAttribute('content', 'Shot Blasting Shrewsbury');
    } else {
      const meta = document.createElement('meta');
      meta.setAttribute('property', 'og:title');
      meta.setAttribute('content', 'Shot Blasting Shrewsbury');
      document.head.appendChild(meta);
    }
    ...
    if (twitterTitle) {
      twitterTitle.setAttribute('content', 'Shot Blasting Shrewsbury');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'twitter:title';
      meta.content = 'Shot Blasting Shrewsbury';
      document.head.appendChild(meta);
    }
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Professional Site Preparation & Environmental Protection
              </h2>
              <p className="text-lg text-gray-600 mb-8">
                Effective shot blasting requires careful preparation and complete cleanup. Our comprehensive approach to site containment, protective measures, and restoration ensures Shrewsbury businesses achieve exceptional surface preparation with minimal disruption to ongoing operations.
              </p>
...
<footer className="bg-[#2C2C2C] text-white py-10">
      ...
      <NearbyTowns 
        locationName={nearbyTownsData["shrewsbury"].location}
        towns={nearbyTownsData["shrewsbury"].towns}
      />
