        ...
        <div className="container relative">
          <Breadcrumb 
            items={[
              ...
              { label: "Hertfordshire & Bedfordshire", href: "/service-areas/hertfordshire-bedfordshire" }
            ]}
          />
          <div className="max-w-3xl mt-8">
            <div className="flex items-center gap-2 text-[#7ac5e3] mb-4">
              <MapPin className="h-5 w-5" />
              <span className="text-sm font-medium uppercase tracking-wider">Hertfordshire & Bedfordshire Region</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6 font-display">
              Shot Blasting Services in Hertfordshire & Bedfordshire
            </h1>
            <p className="text-xl text-gray-200 mb-8">
              Professional shot blasting services across Hertfordshire and Bedfordshire. Covering Luton, Bedford, Stevenage, Watford, Hemel Hempstead and surrounding areas.
            </p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1e3a5f] mb-4">
              Our Service Areas in Hertfordshire & Bedfordshire
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              We provide professional shot blasting services across all areas of Hertfordshire & Bedfordshire. 
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-[#1e3a5f] mb-6">
                Professional Shot Blasting Across Hertfordshire & Bedfordshire
              </h2>
              <p className="text-gray-600 mb-6">
                Our mobile shot blasting teams cover the entire Hertfordshire & Bedfordshire region, providing 
            ...
            <div className="relative">
              <img loading="lazy"
                ...
                alt="Shot blasting services in Hertfordshire & Bedfordshire"
