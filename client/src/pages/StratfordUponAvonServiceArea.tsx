...
export default function StratfordUponAvonServiceArea() {
  ...
  useEffect(() => {
    document.title = "Shot Blasting Stratford-upon-Avon | Industrial";
    
    // Set keywords meta tag
    const metaKeywords = document.querySelector('meta[name="keywords"]');
    if (metaKeywords) {
      metaKeywords.setAttribute('content', 'shot blasting Stratford-upon-Avon, rust removal, surface preparation, industrial blasting, Warwickshire');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'keywords';
      meta.content = 'shot blasting Stratford-upon-Avon, rust removal, surface preparation, industrial blasting, Warwickshire';
  ...
  useEffect(() => {
    ...
    if (ogTitle) {
      ogTitle.setAttribute('content', 'Shot Blasting Stratford Upon Avon');
    } else {
      const meta = document.createElement('meta');
      meta.setAttribute('property', 'og:title');
      meta.setAttribute('content', 'Shot Blasting Stratford Upon Avon');
      document.head.appendChild(meta);
    }
    ...
    if (twitterTitle) {
      twitterTitle.setAttribute('content', 'Shot Blasting Stratford Upon Avon');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'twitter:title';
      meta.content = 'Shot Blasting Stratford Upon Avon';
      document.head.appendChild(meta);
    }
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Shot blasting success depends on meticulous preparation and responsible cleanup. We follow a rigorous approach to site protection, containment, and thorough restoration – delivering predictable results and leaving Stratford-upon-Avon sites ready for immediate next steps.
              </p>
      ...
      <NearbyTowns 
        locationName={nearbyTownsData["stratford-upon-avon"].location}
        towns={nearbyTownsData["stratford-upon-avon"].towns}
      />
