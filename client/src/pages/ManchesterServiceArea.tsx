...
export default function ManchesterServiceArea() {
  ...
  useEffect(() => {
    document.title = "Shot Blasting Manchester | Industrial Services";
    
    // Set keywords meta tag
    const metaKeywords = document.querySelector('meta[name="keywords"]');
    if (metaKeywords) {
      metaKeywords.setAttribute('content', 'shot blasting Manchester, rust removal, surface preparation, industrial blasting, Greater Manchester');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'keywords';
      meta.content = 'shot blasting Manchester, rust removal, surface preparation, industrial blasting, Greater Manchester';
  ...
  useEffect(() => {
    ...
    if (ogTitle) {
      ogTitle.setAttribute('content', 'Shot Blasting Manchester');
    } else {
      const meta = document.createElement('meta');
      meta.setAttribute('property', 'og:title');
      meta.setAttribute('content', 'Shot Blasting Manchester');
      document.head.appendChild(meta);
    }
    ...
    if (twitterTitle) {
      twitterTitle.setAttribute('content', 'Shot Blasting Manchester');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'twitter:title';
      meta.content = 'Shot Blasting Manchester';
      document.head.appendChild(meta);
    }
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      </HeroCarousel>{/* About Manchester Service Area */}
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img loading="lazy"
                src="/images/premier/gate-metal-after.webp"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Professional Preparation & Site Restoration
              </h2>
              <p className="text-lg text-gray-600 mb-8">
                Effective shot blasting demands careful preparation and thorough cleanup. Our systematic approach to site containment, protective measures, and post-blast restoration ensures Manchester businesses achieve exceptional surface preparation with minimal disruption to operations.
              </p>
      ...
      <NearbyTowns 
        locationName={nearbyTownsData["manchester"].location}
        towns={nearbyTownsData["manchester"].towns}
      />
