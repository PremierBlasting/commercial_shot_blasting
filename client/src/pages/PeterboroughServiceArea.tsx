...
export default function PeterboroughServiceArea() {
  ...
  useEffect(() => {
    document.title = "Shot Blasting Peterborough | Industrial Services";
    
    // Set keywords meta tag
    const metaKeywords = document.querySelector('meta[name="keywords"]');
    if (metaKeywords) {
      metaKeywords.setAttribute('content', 'shot blasting Peterborough, rust removal, surface preparation, industrial blasting, Cambridgeshire');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'keywords';
      meta.content = 'shot blasting Peterborough, rust removal, surface preparation, industrial blasting, Cambridgeshire';
      document.head.appendChild(meta);
    }
  }, []);

  useEffect(() => {
    const description = locationData["peterborough"].description;
    ...
    if (ogTitle) {
      ogTitle.setAttribute('content', 'Shot Blasting Peterborough');
    } else {
      const meta = document.createElement('meta');
      meta.setAttribute('property', 'og:title');
      meta.setAttribute('content', 'Shot Blasting Peterborough');
      document.head.appendChild(meta);
    }
    ...
    if (twitterTitle) {
      twitterTitle.setAttribute('content', 'Shot Blasting Peterborough');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'twitter:title';
      meta.content = 'Shot Blasting Peterborough';
      document.head.appendChild(meta);
    }
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-4 bg-gray-50 border-b border-gray-200">
        <div className="container">
          <Breadcrumb items={[
            ...
            { label: "East of England", href: "/service-areas#east-england" },
      ...
      </HeroCarousel>{/* About Peterborough Service Area */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Detailed Site Preparation & Cleanup Standards
              </h2>
              <p className="text-lg text-gray-600 mb-8">
                Quality shot blasting demands meticulous preparation and responsible cleanup. Our systematic four-stage process for site containment, protective measures, and complete restoration ensures Peterborough projects deliver superior results while maintaining operational continuity.
              </p>
      ...
      <NearbyTowns 
        locationName={nearbyTownsData["peterborough"].location}
        towns={nearbyTownsData["peterborough"].towns}
      />
