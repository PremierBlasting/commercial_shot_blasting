...
export default function SheffieldServiceArea() {
  ...
  useEffect(() => {
    document.title = "Shot Blasting Sheffield | Steel & Metal Cleaning";
    
    // Set keywords meta tag
    const metaKeywords = document.querySelector('meta[name="keywords"]');
    if (metaKeywords) {
      metaKeywords.setAttribute('content', 'shot blasting Sheffield, rust removal, surface preparation, steel cleaning, South Yorkshire');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'keywords';
      meta.content = 'shot blasting Sheffield, rust removal, surface preparation, steel cleaning, South Yorkshire';
      document.head.appendChild(meta);
    }
  }, []);

  useEffect(() => {
    const description = locationData["sheffield"].description;
    ...
    if (ogTitle) {
      ogTitle.setAttribute('content', 'Shot Blasting Sheffield');
    } else {
      const meta = document.createElement('meta');
      meta.setAttribute('property', 'og:title');
      meta.setAttribute('content', 'Shot Blasting Sheffield');
      document.head.appendChild(meta);
    }
    ...
    if (twitterTitle) {
      twitterTitle.setAttribute('content', 'Shot Blasting Sheffield');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'twitter:title';
      meta.content = 'Shot Blasting Sheffield';
      document.head.appendChild(meta);
    }
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img loading="lazy"
                src="/images/premier/warehouse-bars-after.webp"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Expert Preparation & Site Restoration
              </h2>
              <p className="text-lg text-gray-600 mb-8">
                Shot blasting excellence starts with preparation and concludes with cleanup. We implement a proven approach to site protection, containment systems, and thorough post-blast restoration – delivering consistent results and leaving Sheffield sites ready for the next work phase.
              </p>
      ...
      <NearbyTowns 
        locationName={nearbyTownsData["sheffield"].location}
        towns={nearbyTownsData["sheffield"].towns}
      />
