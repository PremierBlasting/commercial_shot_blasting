...
export default function BirminghamServiceArea() {
  ...
  useEffect(() => {
    document.title = "Shot Blasting Birmingham | Commercial & Industrial";
    
    // Set keywords meta tag
    const metaKeywords = document.querySelector('meta[name="keywords"]');
    if (metaKeywords) {
      metaKeywords.setAttribute('content', 'shot blasting Birmingham, rust removal, surface preparation, industrial blasting, West Midlands');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'keywords';
      meta.content = 'shot blasting Birmingham, rust removal, surface preparation, industrial blasting, West Midlands';
      document.head.appendChild(meta);
    }
  }, []);

  useEffect(() => {
    const description = locationData["birmingham"].description;
    ...
    if (ogTitle) {
      ogTitle.setAttribute('content', 'Shot Blasting Birmingham | Commercial & Industrial');
    } else {
      const meta = document.createElement('meta');
      meta.setAttribute('property', 'og:title');
      meta.setAttribute('content', 'Shot Blasting Birmingham | Commercial & Industrial');
      document.head.appendChild(meta);
    }
    ...
    if (twitterTitle) {
      twitterTitle.setAttribute('content', 'Shot Blasting Birmingham | Commercial & Industrial');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'twitter:title';
      meta.content = 'Shot Blasting Birmingham | Commercial & Industrial';
      document.head.appendChild(meta);
    }
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      </HeroCarousel>{/* About Birmingham Service Area */}
      ...
      <CaseStudy
        ...
        beforeImage="/case-study-before.webp"
        afterImage="/case-study-after.webp"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Professional Preparation & Site Protection
              </h2>
              <p className="text-lg text-gray-600 mb-8">
                Shot blasting excellence depends on meticulous preparation and cleanup. We take pride in our comprehensive approach to site protection, containment, and post-blast restoration – ensuring minimal disruption to Birmingham's busy industrial operations and maximum quality on every project.
              </p>
