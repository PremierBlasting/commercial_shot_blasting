...
export default function WestMidlandsCounty() {
  ...
  useEffect(() => {
    document.title = "Shot Blasting West Midlands | Service Areas";
    
    // Set keywords meta tag
    const metaKeywords = document.querySelector('meta[name="keywords"]');
    if (metaKeywords) {
      metaKeywords.setAttribute('content', 'shot blasting West Midlands, mobile shot blasting, rust removal, surface preparation, West Midlands');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'keywords';
      meta.content = 'shot blasting West Midlands, mobile shot blasting, rust removal, surface preparation, West Midlands';
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Professional shot blasting services across the West Midlands region. We cover Birmingham, Wolverhampton, Coventry and surrounding areas with mobile shot blasting for commercial and industrial projects.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Professional shot blasting services across the West Midlands region. We cover Birmingham, Wolverhampton, Coventry and surrounding areas with mobile shot blasting for commercial and industrial projects.';
      document.head.appendChild(meta);
    }
    ...
    if (ogTitle) {
      ogTitle.setAttribute('content', 'Shot Blasting West Midlands | Service Areas');
    }

    const ogDescription = document.querySelector('meta[property="og:description"]');
    if (ogDescription) {
      ogDescription.setAttribute('content', 'Professional shot blasting services across the West Midlands region. We cover Birmingham, Wolverhampton, Coventry and surrounding areas with mobile shot blasting for commercial and industrial projects.');
    }
        ...
        <div className="container relative">
          <Breadcrumb 
            items={[
              ...
              { label: "West Midlands", href: "/service-areas/west-midlands" }
            ]}
          />
          <div className="max-w-3xl mt-8">
            <div className="flex items-center gap-2 text-[#7ac5e3] mb-4">
              <MapPin className="h-5 w-5" />
              <span className="text-sm font-medium uppercase tracking-wider">West Midlands Region</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6 font-display">
              Shot Blasting Services in West Midlands
            </h1>
            <p className="text-xl text-gray-200 mb-8">
              Professional shot blasting services across the West Midlands region. We cover Birmingham, Wolverhampton, Coventry and surrounding areas with mobile shot blasting for commercial and industrial projects.
            </p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1e3a5f] mb-4">
              Our Service Areas in West Midlands
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              We provide professional shot blasting services across all areas of West Midlands. 
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-[#1e3a5f] mb-6">
                Professional Shot Blasting Across West Midlands
              </h2>
              <p className="text-gray-600 mb-6">
                Our mobile shot blasting teams cover the entire West Midlands region, providing 
      ...
      <section className="py-16 bg-[#1e3a5f] text-white">
        <div className="container text-center">
          <h2 className="text-3xl font-bold mb-4">
            Ready to Get Started in West Midlands?
          </h2>
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Contact us today for a free quote on your shot blasting project. 
            We cover all areas of West Midlands with our mobile shot blasting service.
          </p>
