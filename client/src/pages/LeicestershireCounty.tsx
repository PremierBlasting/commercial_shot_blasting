...
export default function LeicestershireCounty() {
  ...
  useEffect(() => {
    document.title = "Shot Blasting Leicestershire | Service Areas";
    
    const metaKeywords = document.querySelector('meta[name="keywords"]');
    if (metaKeywords) {
      metaKeywords.setAttribute('content', 'shot blasting Leicestershire, mobile shot blasting, rust removal, surface preparation, Leicestershire');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'keywords';
      meta.content = 'shot blasting Leicestershire, mobile shot blasting, rust removal, surface preparation, Leicestershire';
      document.head.appendChild(meta);
    }

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Shot Blasting Leicestershire - Professional rust removal & surface preparation. Covering Leicester, Loughborough, Coalville. Call 07970 566409');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Shot Blasting Leicestershire - Professional rust removal & surface preparation. Covering Leicester, Loughborough, Coalville. Call 07970 566409';
      document.head.appendChild(meta);
    }

    const ogTitle = document.querySelector('meta[property="og:title"]');
    if (ogTitle) {
      ogTitle.setAttribute('content', 'Shot Blasting Leicestershire | Service Areas');
    }

    const ogDescription = document.querySelector('meta[property="og:description"]');
    if (ogDescription) {
      ogDescription.setAttribute('content', 'Shot Blasting Leicestershire - Professional rust removal & surface preparation. Covering Leicester, Loughborough, Coalville. Call 07970 566409');
    }
        ...
        <div className="container relative">
          <Breadcrumb 
            items={[
              ...
              { label: "Leicestershire", href: "/service-areas/leicestershire" }
            ]}
          />
          <div className="max-w-3xl mt-8">
            <div className="flex items-center gap-2 text-[#7ac5e3] mb-4">
              <MapPin className="h-5 w-5" />
              <span className="text-sm font-medium uppercase tracking-wider">Leicestershire</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6 font-display">
              Shot Blasting Services in Leicestershire
            </h1>
            <p className="text-xl text-gray-200 mb-8">
              Professional shot blasting services across Leicestershire. Covering Leicester, Loughborough, Coalville and surrounding areas.
            </p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We provide professional shot blasting services across all areas of Leicestershire. 
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-[#1e3a5f] mb-6">
                Professional Shot Blasting Across Leicestershire
              </h2>
              <p className="text-gray-600 mb-6">
                Our mobile shot blasting teams cover the entire Leicestershire region, providing 
