...
const ContactForm = ({ formData, setFormData, handleSubmit, submitContact }: { formData: { name: string; email: string; phone: string; message: string }; setFormData: React.Dispatch<React.SetStateAction<{ name: string; email: string; phone: string; message: string }>>; handleSubmit: (e: React.FormEvent) => void; submitContact: { isPending: boolean } }) => (
...
export default function LincolnServiceArea() {
  ...
  useEffect(() => {
    document.title = "Shot Blasting Lincoln | Commercial & Industrial";
    
    // Set keywords meta tag
    const metaKeywords = document.querySelector('meta[name="keywords"]');
    if (metaKeywords) {
      metaKeywords.setAttribute('content', 'shot blasting Lincoln, rust removal, surface preparation, industrial blasting, Lincolnshire');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'keywords';
      meta.content = 'shot blasting Lincoln, rust removal, surface preparation, industrial blasting, Lincolnshire';
      document.head.appendChild(meta);
    }
  }, []);

  useEffect(() => {
    const description = locationData["lincoln"].description;
    ...
    if (ogTitle) {
      ogTitle.setAttribute('content', 'Shot Blasting Lincoln');
    } else {
      const meta = document.createElement('meta');
      meta.setAttribute('property', 'og:title');
      meta.setAttribute('content', 'Shot Blasting Lincoln');
      document.head.appendChild(meta);
    }
    ...
    if (twitterTitle) {
      twitterTitle.setAttribute('content', 'Shot Blasting Lincoln');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'twitter:title';
      meta.content = 'Shot Blasting Lincoln';
      document.head.appendChild(meta);
    }
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img loading="lazy" src="https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=600" alt="Professional shot blasting in Lincoln" className="rounded-lg shadow-xl" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Detailed Preparation & Environmental Protection
              </h2>
              <p className="text-lg text-gray-600 mb-8">
                Quality shot blasting requires meticulous preparation and responsible cleanup. Our structured approach to site containment, protective measures, and thorough restoration ensures Lincoln projects deliver superior results while maintaining waste management throughout.
              </p>
...
<footer className="bg-[#2C2C2C] text-white py-8">
      ...
      <NearbyTowns 
        locationName={nearbyTownsData["lincoln"].location}
        towns={nearbyTownsData["lincoln"].towns}
      />
