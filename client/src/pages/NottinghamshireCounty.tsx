        ...
        <div className="container relative">
          <Breadcrumb 
            items={[
              ...
              { label: "Nottinghamshire", href: "/service-areas/nottinghamshire" }
            ]}
          />
          <div className="max-w-3xl mt-8">
            <div className="flex items-center gap-2 text-[#7ac5e3] mb-4">
              <MapPin className="h-5 w-5" />
              <span className="text-sm font-medium uppercase tracking-wider">Nottinghamshire</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6 font-display">
              Shot Blasting Services in Nottinghamshire
            </h1>
            <p className="text-xl text-gray-200 mb-8">
              Professional shot blasting services across Nottinghamshire. Covering Nottingham, Mansfield and surrounding areas.
            </p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1e3a5f] mb-4">
              Our Service Areas in Nottinghamshire
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              We provide professional shot blasting services across all areas of Nottinghamshire. 
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-[#1e3a5f] mb-6">
                Professional Shot Blasting Across Nottinghamshire
              </h2>
              <p className="text-gray-600 mb-6">
                Our mobile shot blasting teams cover the entire Nottinghamshire region, providing 
            ...
            <div className="relative">
              <img loading="lazy"
                ...
                alt="Shot blasting services in Nottinghamshire"
      ...
      <section className="py-16 bg-[#1e3a5f] text-white">
        <div className="container text-center">
          <h2 className="text-3xl font-bold mb-4">
            Ready to Get Started in Nottinghamshire?
          </h2>
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Contact us today for a free quote on your shot blasting project. 
            We cover all areas of Nottinghamshire with our mobile shot blasting service.
          </p>
