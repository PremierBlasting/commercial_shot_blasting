...
export default function ChesterfieldServiceArea() {
  ...
  useEffect(() => {
    document.title = "Shot Blasting Chesterfield | Industrial Services";
    
    // Set keywords meta tag
    const metaKeywords = document.querySelector('meta[name="keywords"]');
    if (metaKeywords) {
      metaKeywords.setAttribute('content', 'shot blasting Chesterfield, rust removal, surface preparation, industrial blasting, Derbyshire');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'keywords';
      meta.content = 'shot blasting Chesterfield, rust removal, surface preparation, industrial blasting, Derbyshire';
      document.head.appendChild(meta);
    }
  }, []);

  useEffect(() => {
    const description = locationData["chesterfield"].description;
    ...
    if (ogTitle) {
      ogTitle.setAttribute('content', 'Shot Blasting Chesterfield');
    } else {
      const meta = document.createElement('meta');
      meta.setAttribute('property', 'og:title');
      meta.setAttribute('content', 'Shot Blasting Chesterfield');
      document.head.appendChild(meta);
    }
    ...
    if (twitterTitle) {
      twitterTitle.setAttribute('content', 'Shot Blasting Chesterfield');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'twitter:title';
      meta.content = 'Shot Blasting Chesterfield';
      document.head.appendChild(meta);
    }
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      </HeroCarousel>{/* About Chesterfield Service Area */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Detailed Preparation & Cleanup Standards
              </h2>
              <p className="text-lg text-gray-600 mb-8">
                Quality shot blasting is defined by preparation and cleanup excellence. Our methodical approach to site protection, containment systems, and thorough post-blast restoration ensures Chesterfield facilities receive outstanding results with minimal operational impact.
              </p>
