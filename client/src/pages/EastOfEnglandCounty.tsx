...
export default function EastOfEnglandCounty() {
  const [quotePopupOpen, setQuotePopupOpen] = useState(false);

  useEffect(() => {
    document.title = "Shot Blasting East of England | Service Areas";
    
    // Set keywords meta tag
    const metaKeywords = document.querySelector('meta[name="keywords"]');
    if (metaKeywords) {
      metaKeywords.setAttribute('content', 'shot blasting East of England, mobile shot blasting, rust removal, surface preparation, East of England');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'keywords';
      meta.content = 'shot blasting East of England, mobile shot blasting, rust removal, surface preparation, East of England';
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Expert shot blasting services across East of England. Covering Norwich, Cambridge, Ipswich, Peterborough, Colchester and surrounding areas.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Expert shot blasting services across East of England. Covering Norwich, Cambridge, Ipswich, Peterborough, Colchester and surrounding areas.';
      document.head.appendChild(meta);
    }
    ...
    if (ogTitle) {
      ogTitle.setAttribute('content', 'Shot Blasting East of England | Service Areas');
    }

    const ogDescription = document.querySelector('meta[property="og:description"]');
    if (ogDescription) {
      ogDescription.setAttribute('content', 'Expert shot blasting services across East of England. Covering Norwich, Cambridge, Ipswich, Peterborough, Colchester and surrounding areas.');
    }
        ...
        <div className="container relative">
          <Breadcrumb 
            items={[
              ...
              { label: "East of England", href: "/service-areas/east-of-england" }
            ]}
          />
          <div className="max-w-3xl mt-8">
            <div className="flex items-center gap-2 text-[#7ac5e3] mb-4">
              <MapPin className="h-5 w-5" />
              <span className="text-sm font-medium uppercase tracking-wider">East of England Region</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6 font-display">
              Shot Blasting Services in East of England
            </h1>
            <p className="text-xl text-gray-200 mb-8">
              Expert shot blasting services across East of England. Covering Norwich, Cambridge, Ipswich, Peterborough, Colchester and surrounding areas.
            </p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1e3a5f] mb-4">
              Our Service Areas in East of England
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              We provide professional shot blasting services across all areas of East of England. 
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-[#1e3a5f] mb-6">
                Professional Shot Blasting Across East of England
              </h2>
              <p className="text-gray-600 mb-6">
                Our mobile shot blasting teams cover the entire East of England region, providing 
            ...
            <div className="relative">
              <img loading="lazy"
                ...
                alt="Shot blasting services in East of England"
      ...
      <section className="py-16 bg-[#1e3a5f] text-white">
        <div className="container text-center">
          <h2 className="text-3xl font-bold mb-4">
            Ready to Get Started in East of England?
          </h2>
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Contact us today for a free quote on your shot blasting project. 
            We cover all areas of East of England with our mobile shot blasting service.
          </p>
